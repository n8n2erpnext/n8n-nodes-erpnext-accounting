...
export class ErpNextAccounting implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'ERPNext Accounting',
		name: 'erpNextAccounting',
		icon: 'file:erpnext-accounting.svg',
		group: ['transform'],
		version: 1,
		subtitle: '={{$parameter["resource"] + ": " + $parameter["operation"]}}',
		description: 'Work with ERPNext/Frappe Accounting v15-v16 documents and methods',
		defaults: {
		...
		properties: [
			...
			},
			{
				...
				default: '[]',
				description:
					'Frappe filters JSON. Example: [["docstatus","=",1]] or {"customer":"Customer Name"}.',
				displayOptions: {
					show: {
						operation: ['getMany'],
					},
